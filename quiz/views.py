...
import difflib
from .check import check_similarity
...
def show_cheaters(request):
    ...
    MIN_MATCH_LEN = 5
    SIMILARITY_THRESHOLD = 0.5  # Lowered from 0.5
    ...
    for i in range(len(students)):
        for j in range(i + 1, len(students)):
            ...
            for qnum in question_numbers:
                ...
                if diff_similarity > SIMILARITY_THRESHOLD or cosine_sim > COSINE_THRESHOLD and check_similarity(ans1, ans2) >= 0.6:
